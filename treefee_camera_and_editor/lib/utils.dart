...
class PermissionUtil {
  ...
  static void showDeniedDialog(BuildContext context) {
    HDialog.show(
        context: context,
        title: 'Exception in permission application',
        content: 'Please enable all required permissions in [Application Information]-[Permission Management] to use the Huibo Order function normally.',
        options: <DialogAction>[
          DialogAction(text: 'Go to settings', onPressed: () => openAppSettings())
        ]);
  }
